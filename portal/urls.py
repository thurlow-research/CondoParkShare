...
urlpatterns = [
    ...
    path(
        "residents/<int:pk>/approve/",
        views.resident_approve,
        name="portal_resident_approve",
    ),
    path(
        "residents/<int:pk>/block/", views.resident_block, name="portal_resident_block"
    ),
    path(
        "residents/<int:pk>/unblock/",
        views.resident_unblock,
        name="portal_resident_unblock",
    ),
    # Spot management
    path("spots/", views.spot_list, name="portal_spot_list"),
    path("spots/<int:pk>/approve/", views.spot_approve, name="portal_spot_approve"),
    path(
        "spots/<int:pk>/deactivate/",
        views.spot_deactivate,
        name="portal_spot_deactivate",
    ),
    # Invite management
    ...
    path(
        ...
        views.portal_booking_cancel,
        name="portal_booking_cancel",
    ),
    # Reports
