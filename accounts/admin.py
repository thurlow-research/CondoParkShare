...
live in operator_console/admin.py so the operator console can co-locate them with
parking model registrations and apply the unscoped-manager pattern uniformly.

The pii_erasure bulk action is defined in operator_console/admin.py alongside UserAdmin.
"""
