...
def get_leaderboard(organization, limit=20):
    ...
    Elapsed hours are counted from AvailabilityWindows that:
    - Are fully in the past (upper bound <= now)
    - Fall within the organisation's rolling metric window
    - Belong to an active ParkingSpot
